...
# Check standard specification for conditional logit #
dir.create("Figures/clogit")
...
for(city_name in city_names){
  model <- apollo_loadModel(paste0("Estimation_results/c_logit/Clogit_full_", city_name))
...
ggsave("Figures/clogit/clogit_wtp_cities_ci.png", dpi = "print",  width = 7, height = 5)
...
ggsave("Figures/clogit/clogit__walking_dist_cities_ci_ordered.png", dpi = "print",  width = 7, height = 5)
...
ggsave("Figures/clogit/clogit__walking_dist_cities_ci.png", dpi = "print",  width = 7, height = 5)
...
ggsave("Figures/clogit/clogit__rent_ci_ordered.png", dpi = "print",  width = 7, height = 5)
...
ggsave("Figures/clogit/clogit__rent_ci.png", dpi = "print",  width = 7, height = 5)
...
ggsave("Figures/clogit/clogit_corr_natural_distance.png", dpi = "print",  width = 7, height = 5)
...
ggsave("Figures/clogit/clogit_corr_natural_rent.png", dpi = "print",  width = 7, height = 5)
