...
for (i in citylist) {
  ...
  ### Set core controls
  apollo_control = list(
    modelName  = paste0("MXL_full_log_", city_names[z]),
    modelDescr = paste0("WTP_full_log_rent ", city_names[z]),
    indivID    ="id",
    mixing     = TRUE,
    HB= FALSE,
  ...
  mxl_log = apollo_estimate(apollo_beta, apollo_fixed,
