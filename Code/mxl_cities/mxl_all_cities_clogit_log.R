...
for (i in citylist) {
  ...
  ### Set core controls
  apollo_control = list(
    modelName  = paste0("Clogit_full_log_", city_names[z]),
    modelDescr = paste0("ClogitWTP_full_log ", city_names[z]),
    indivID    ="id",
    mixing     = FALSE,
    HB= FALSE,
  ...
  clogit_log = apollo_estimate(apollo_beta, apollo_fixed,
